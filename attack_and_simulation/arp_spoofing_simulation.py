...
def get_mac(ip):
    ...
    answered_list = scp.srp(arp_broadcast_packet, timeout=1, verbose=False)[0]
...
def restore(destination_ip, source_ip):
    ...
    scp.send(packet, 4)  # sending 4 packets incase of packet loss
...
try:
    while True:
        ...
        sent_packets += 2
        print("\rSent packets: " + str(sent_packets)),
        sys.stdout.flush()
        time.sleep(2)
